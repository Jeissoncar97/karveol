			...
			<div className="max-w-7xl grid items-center justify-center md:justify-normal w-full grid-cols-[auto_1fr] mx-auto text-white gap-x-10 md:flex max-w-screen-full">
				...
				<div className="flex md:flex-grow md:basis-0 items-center gap-4 mr-4 ml-auto md:ml-0 justify-end">
					<Link
						onClick={closeMenu}
						to="/log-in"
						className="cursor-pointer px-4 justify-center rounded-[10px] flex items-center gap-x-2.5 hover:scale-105 transition-transform duration-300 bg-primary text-white border-brand-blue font-bold text-lg py-1.5"
					>
						Iniciar Sesión
					</Link>
					<button
