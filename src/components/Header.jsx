      ...
      <div className="max-w-7xl grid items-center justify-center md:justify-normal w-full grid-cols-[auto_1fr] mx-auto text-white gap-x-10 md:flex max-w-screen-full">
        <div className="md:flex-grow md:basis-0 flex justify-start">
          ...
          >
            ...
            <span className="text-[32px] font-bold">Karveol</span>
          </a>
        </div>
        ...
        >
          <ul className="flex flex-col items-center overflow-hidden md:flex-row gap-x-2">
              ...
              >
                <a
                  href="#"
                  className="flex items-center md:w-auto justify-center gap-2 md:px-4 md:py-2 hover:bg-brand-gray-mix md:rounded-2xl border border-transparent hover:border-brand-gray/10 transition-all min-h-[50px] md:text-base px-5 py-4 text-xl duration-300 w-full"
                >
              ...
              >
                <a
                  href="#"
                  className="flex items-center md:w-auto justify-center gap-2 md:px-4 md:py-2 hover:bg-brand-gray/5 md:rounded-2xl border border-transparent hover:border-brand-gray/10 transition-all min-h-[50px] md:text-base px-5 py-4 text-xl duration-300 w-full"
                >
