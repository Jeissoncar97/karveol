        ...
        >
          <ul className="flex flex-col items-center overflow-hidden md:flex-row gap-x-2">
              ...
              >
                <a
                  href="#"
                  className="flex items-center md:w-auto justify-center gap-2 md:px-4 md:py-2 hover:bg-red md:rounded-2xl border border-transparent hover:border-red transition-all min-h-[50px] md:text-base px-5 py-4 text-xl duration-300 w-full"
                >
