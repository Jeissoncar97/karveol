...
const topAutomations = [
	{
		...
		description:
			'Envía tus gastos por mensaje y guárdalos automáticamente en Google Sheets.',
	...
	},
	{
		...
		description:
			'Envía alertas automáticas a tus clientes antes de que se venza una factura.',
	...
	},
	{
		...
		description:
			'Agrega un producto a Sheets y publícalo en Instagram con foto y precio.',
	...
	},
	{
		...
		description:
			'Responde mensajes frecuentes con texto automático personalizado.',
	...
	},
	{
		...
		description:
			'Cuando un cliente llena un formulario, recibe su cotización por correo en segundos.',
	...
	},
	{
		...
		description:
			'Automatiza una copia de seguridad diaria desde una carpeta específica.',
		image: 'images/images-top/prueba1.png',
		tag: 'Gratis',
		level: 'Intermedio',
	...
	},
	{
		...
		description:
			"Crea y envía facturas PDF cuando marcas un cliente como 'listo'.",
		image: 'images/images-top/prueba2.png',
		tag: 'Premium',
		level: 'Avanzado',
		category: 'Finanzas',
	},
	{
		...
		description:
			'Responde automáticamente preguntas frecuentes en publicaciones de Facebook o Instagram.',
		image: 'images/images-top/prueba3.png',
		tag: 'Premium',
		level: 'Avanzado',
		category: 'Redes Sociales',
	...
	},
	{
		...
		description:
			'Cuando alguien llena un formulario, se guarda en Google Contacts automáticamente.',
		image: 'images/images-top/prueba5.png',
		tag: 'Gratis',
		level: 'Básico',
		category: 'Productividad',
...
export default function TopAutomations() {
	...
	const uniqueTypes = [
		'Todos',
		...new Set(topAutomations.map((auto) => auto.tag)),
	];
	const uniqueCategories = [
		'Todas',
		...new Set(topAutomations.map((auto) => auto.category)),
	];
	const uniqueLevels = [
		'Todos',
		...new Set(topAutomations.map((auto) => auto.level)),
	];
		...
		<div>
			<div className="max-w-7xl mx-auto text-center mb-10">
				<p className="text-zinc-400 mt-2">
					Explora y filtra según tus necesidades.
				</p>
			</div>
					...
					filtered.map((auto, i) => (
						...
						>
							<div className="relative">
								...
								<span
									className={`absolute top-3 left-3 px-3 py-1 rounded-full text-xs font-semibold ${
										auto.tag === 'Gratis' ? 'bg-green-500' : 'bg-indigo-500'
									}`}
								>
									{auto.tag}
								</span>
							...
							<div className="p-5">
								<a
									href="#"
									className="text-2xl text-white/80 font-semibold mb-2 my-40"
								>
									<h3>{auto.title}</h3>
								</a>
